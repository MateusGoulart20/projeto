...
routes.delete('/perfil', authMiddleware, async (req, res) => {
    try {
...
routes.put('/perfil', authMiddleware, async (req, res) => {
    try {
...
routes.delete('/control/funcionario', authMiddleware, async (req, res) => {
    try {
